...
const Header = () => {
  ...
  return (
    <header className="sticky top-0 z-50 w-full glass-card rounded-none border-t-0 border-l-0 border-r-0 border-b border-brand-primary/20 bg-brand-bg/90 backdrop-blur-md">
